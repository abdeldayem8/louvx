...
export default function FeaturedProducts() {
  ...
  return (
    <section ref={ref} className="py-16 sm:py-20 md:py-24 lg:py-28 bg-neutral-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-14 md:mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 text-white">Featured Products</h2>

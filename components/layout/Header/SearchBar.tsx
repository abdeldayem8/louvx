...
const SearchBar = () => {
  ...
  const filteredResults = query
    ? staticResults.filter((item) => item.title.toLowerCase().includes(query.toLowerCase()))
    : []
    ...
    <div className="relative w-full" ref={searchRef}>
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-10 py-2 rounded-lg bg-background text-foreground border border-input focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200 text-sm"
        />
